...
namespace winrt::impl
{
    ...
    struct consume_Windows_UI_Input_ITouchpadGesturesController
    {
        ...
        [[nodiscard]] TouchpadGlobalActionPerformed_revoker TouchpadGlobalActionPerformed(auto_revoke_t, winrt::Windows::Foundation::TypedEventHandler<winrt::Windows::UI::Input::TouchpadGesturesController, winrt::Windows::UI::Input::TouchpadGlobalActionEventArgs> const& handler) const;
